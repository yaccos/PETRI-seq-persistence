...
cutadapt -g NNNNNNNNAGAATACACGACGCTCTTCCGATCT -o ${sample}/${sample_full}_L001_R1_001.fastq.gz ${sample}/SRR28148450_1.fastq 
cutadapt -g NNNNNNNNAGAATACACGACGCTCTTCCGATCT -o ${sample}/${sample_full}_L001_R2_001.fastq.gz ${sample}/SRR28148450_2.fastq 
