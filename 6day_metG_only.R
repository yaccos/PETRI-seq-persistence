...
seurat <- subset(seurat,idents=c('d6_1hr_1_20220422','d6_1hr_2_20220422','metG1_20200926','d1_1hr_1_20220807'))
...
seurat <- FindClusters(seurat, resolution = 0.16)
...
saveRDS(seurat,'source_data/generated/day6_and_metG_seurat.rds')
