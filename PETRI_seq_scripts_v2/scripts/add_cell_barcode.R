...
celltags <- rlang::exec(paste, !!! barcode_index[c("bc1","bc2","bc3")], sep="_")
names(celltags) <- barcode_index$read
mcols(annotated_alignment)$CB  <- celltags[names(annotated_alignment)]
